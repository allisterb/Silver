...
namespace Silver.Notebooks
{
    ...
    {
        private static void AppendJsCode(StringBuilder stringBuilder, string divId, string functionName, Uri libraryUri, string? libraryVersion, string cacheBuster, VisJS.Network data)
        {
        ...
        private static IHtmlContent GenerateHtml(VisJS.Network network, Uri libraryUri, string? libraryVersion, string cacheBuster, string width, string height)
        {
        ...
        public static void Register()
        {
            ...
            Formatter.Register<VisJS.Network>((network, writer) =>
            {
