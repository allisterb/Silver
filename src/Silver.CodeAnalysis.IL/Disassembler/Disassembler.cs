...
{
    public static void Run(string fileName, ISourceEmitterOutput output, bool noIL = false, bool noStack = true, string? classPattern = null, string? methodPattern = null, bool colorful = false)
    {
